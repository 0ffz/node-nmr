 ...
 */
public fun ComplexDouble(re: Double, im: Double): ComplexDouble = ComplexDouble64(re, im)
 ...
 * @param im the imaginary part.
 */
public fun ComplexDouble(re: Number, im: Number): ComplexDouble = ComplexDouble64(re.toDouble(), im.toDouble())
